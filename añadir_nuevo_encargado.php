...
<head>
    ...
    <title>Añadir Nuevo Encargado de Laboratorio</title>
    <style>
        body {
...
<a href="javascript:history.back()" class="back-arrow">&#x2190; </a>
    ...
    <div class="container">
        <div class="title">Añadir Nuevo Encargado de Laboratorio</div>
        <form action="guardar_encargado.php" method="POST">
            <div class="form-group">
                <label for="IDEncargadoLaboratorio">ID Encargado de Laboratorio</label>
                <input type="text" id="IDEncargadoLaboratorio" name="IDEncargadoLaboratorio" required>
            </div>
            <div class="form-group">
