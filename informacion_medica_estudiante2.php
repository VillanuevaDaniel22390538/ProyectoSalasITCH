...
<head>
    ...
    <title>Añadir Información Médica del Estudiante</title>
    <style>
        body {
...
<a href="javascript:history.back()" class="back-arrow">&#x2190; </a>
    ...
    <div class="container">
        <h1>Añadir Información Médica del Estudiante</h1>
        <form action="guardar_informacion_medica_estudiante.php" method="POST" onsubmit="return validateForm()">
            <div class="form-row">
