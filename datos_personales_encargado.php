...
<head>
    ...
    <title>Añadir Datos Personales del Encargado de Laboratorio</title>
    <style>
        body {
...
<body>
<div class="container"> 
    <h1>Añadir Datos Personales del Encargado de Laboratorio</h1> 
    <form action="guardar_datos_personales_encargado.php" method="POST" onsubmit="return validateForm()"> 
        <?php 
