...
<head>
    ...
    <title>Añadir Nuevo Jefe de Departamento</title>
    <style>
        body {
...
<a href="javascript:history.back()" class="back-arrow">&#x2190; </a>
    ...
    <div class="container">
        <div class="title">Añadir Nuevo Jefe de Departamento</div>
        <form action="guardar_jefe_departamento.php" method="POST">
            <div class="form-group">
                <label for="IDJefeDeDepartamento">ID Jefe de Departamento</label>
                <input type="text" id="IDJefeDeDepartamento" name="IDJefeDeDepartamento" required>
            </div>
            <div class="form-group">
