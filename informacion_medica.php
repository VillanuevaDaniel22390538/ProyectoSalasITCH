...
<head>
    ...
    <title>Añadir Información Médica</title>
    <style>
        body {
...
<a href="javascript:history.back()" class="back-arrow">&#x2190; </a>
    ...
    <div class="container">
        <h1>Añadir Información Médica</h1>
        <form action="guardar_informacion_medica.php" method="POST" onsubmit="return validateForm()">
            <div class="form-row">
