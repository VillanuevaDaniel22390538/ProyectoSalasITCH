...
try {
    ...
    // Obtener datos de la tabla Sala
    $stmt = $conn->prepare("SELECT * FROM Sala");
    $stmt->execute();
            ...
            <table>
                ...
                <tbody>
                    <?php foreach ($salas as $sala): ?>
                        <tr>
                            <td><?php echo htmlspecialchars($sala['IDSala']); ?></td>
                            <td><?php echo htmlspecialchars($sala['NombreSala']); ?></td>
                            <td><?php echo htmlspecialchars($sala['DescripcionSala']); ?></td>
                            <td><?php echo htmlspecialchars($sala['Capacidad']); ?></td>
                            <td><?php echo htmlspecialchars($sala['IDDepartamentoAcademico']); ?></td>
                            <td>
                                <button onclick="location.href='editar_sala.php?id=<?php echo $sala['IDSala']; ?>'"><i class="fas fa-edit"></i> Editar</button>
                                <button onclick="location.href='eliminar_sala.php?id=<?php echo $sala['IDSala']; ?>'"><i class="fas fa-trash-alt"></i> Eliminar</button>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
            <button onclick="location.href='agregar_sala.php'"><i class="fas fa-plus"></i> Agregar Sala</button>
        </div>
