...
try {
    ...
    // Obtener datos de la tabla Carrera
                ...
                <tbody>
                    <?php foreach ($carreras as $carrera): ?>
                        <tr>
                            ...
                            <td><?php echo htmlspecialchars($carrera['DescripcionCarrera']); ?></td>
                            <td>
                                <button onclick="location.href='editar_carrera.php?id=<?php echo $carrera['IDCarrera']; ?>'"><i class="fas fa-edit"></i> Editar</button>
                                <button onclick="location.href='eliminar_carrera.php?id=<?php echo $carrera['IDCarrera']; ?>'"><i class="fas fa-trash-alt"></i> Eliminar</button>
                            </td>
                        </tr>
                    <?php endforeach; ?>
                </tbody>
            </table>
            <button onclick="location.href='agregar_carrera.php'"><i class="fas fa-plus"></i> Agregar Carrera</button>
        </div>
