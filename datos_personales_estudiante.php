...
<head>
    ...
    <title>Añadir Datos Personales del Estudiante</title>
    <style>
        body {
...
<body>
<div class="container"> 
    <h1>Añadir Datos Personales del Estudiante</h1> 
    <form action="guardar_datos_personales_estudiante.php" method="POST" onsubmit="return validateForm()"> 
        <?php 
