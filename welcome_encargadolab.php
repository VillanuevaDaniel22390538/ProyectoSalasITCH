...
if (!isset($_SESSION['username']) || $_SESSION['tipo_usuario'] != 7) {
...
<head>
    ...
    <title>Bienvenido Encargado Laboratorio</title>
    <style>
        /* Estilos generales */
        body, html {
            margin: 0;
...
<header class="header">
    <h1>Bienvenido Encargado Laboratorio</h1>
    <div class="user-info">
...
<div class="main-container">
    <div class="admin-panel">
        <h2>Panel del Encargado de Laboratorio</h2>
